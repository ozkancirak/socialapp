...
export async function POST(req: NextRequest) {
  console.log("Clerk Webhook received at snonkol.com...");
  ...
  console.log(`Processing event type: ${eventType} on snonkol.com`);
  ...
  if (eventType === 'user.deleted') {
      ...
      if (clerkIdToDelete) {
        try {
            // First clean up user-related data
            // This part may vary based on your data model
  ...
  console.log('Webhook processed successfully on snonkol.com.');
